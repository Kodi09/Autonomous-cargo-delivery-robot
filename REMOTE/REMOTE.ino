...
const int frontButton = A4; //pressing the button moves the bot forward
const int backButton = 8;  //pressing the button moves the bot backward
const int leftButton = 9;  //pressing the button moves the bot to the left
const int rightButton = A0; //pressing the button moves the bot to the right
